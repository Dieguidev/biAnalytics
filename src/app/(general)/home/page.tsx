...
const iconServices = [
  {
    ...
    description:
      "Aenaen massa. Cum sooliis natoque penatibus montes nascetur ridiculus mus.",
  },
  {
    ...
    <div className="container mx-auto px-4 py-8">
      <section className="py-10 my-10">
        <div className="container mx-auto px-4 flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 w-full text-center md:text-left">
            <h1 className="text-4xl md:text-5xl font-bold mb-6 text-sky-500 drop-shadow-lg fade-in-up">
              ¿Listo para transformar tu negocio?
            </h1>
            <p className="text-xl mb-8 text-gray-700 fade-in-up">
            ...
            <Link href={'/services'}  className="bg-sky-500 text-white font-bold py-3 px-6 rounded-full hover:bg-sky-600 transition duration-300">
              Comienza ahora
            </Link>
          </div>
      ...
      <section className="relative w-full ">
        ...
        <div className="relative container mx-auto h-full flex flex-col md:flex-row items-center justify-between px-4 py-16">
          ...
          {/* Imagen de la persona en un círculo */}
